(define (problem prob-trace)
  ...
  (:objects
    t76 t12 t42 t77 t93 t6 t70 t81 t68 t29 t21 t13 t52 t51 t48 t90 t26 t50 t3 t95 t71 t72 t85 t92 t89 t20 t56 t63 t28 t74 t78 t23 t8 t53 t45 t17 t44 t57 t0 t30 t58 t80 t27 t55 t96 t36 t18 t39 t94 t15 t31 t84 t22 t14 t97 t19 t41 t67 t88 t65 t64 t86 t1 t9 t75 t82 t32 t38 t11 t24 t99 t5 t4 t10 t25 t34 t69 t98 t40 t46 t43 t54 t16 t33 t35 t61 t49 t73 t79 t2 t87 t7 t59 t62 t60 t66 t91 t47 t83 t37 - trace_state
  ...
  (:init
    ...
    (trace t6 a8 t7)
    (has_parameter a8 categorical t6 t7)
    (= (trace_parameter a8 categorical t6 t7) 3)
    (has_parameter a8 integer t6 t7)
    (= (trace_parameter a8 integer t6 t7) 42)

    (trace t7 a1 t8)
    (has_parameter a1 integer t7 t8)
    (= (trace_parameter a1 integer t7 t8) 10)
    (has_parameter a1 categorical t7 t8)
    (= (trace_parameter a1 categorical t7 t8) 3)
    ...
    (= (trace_parameter a7 categorical t9 t10) 2)

    (trace t10 a10 t11)
    (has_parameter a10 categorical t10 t11)
    (= (trace_parameter a10 categorical t10 t11) 1)
    (has_parameter a10 integer t10 t11)
    (= (trace_parameter a10 integer t10 t11) 9)

    (trace t11 a3 t12)
    (has_parameter a3 integer t11 t12)
    (= (trace_parameter a3 integer t11 t12) 84)
    ...
    (= (trace_parameter a5 integer t13 t14) 36)
    ...
    (= (trace_parameter a9 integer t17 t18) 0)
    ...
    (= (trace_parameter a9 integer t27 t28) 10)
    ...
    (= (trace_parameter a2 integer t38 t39) 10)

    (trace t39 a4 t40)
    (has_parameter a4 integer t39 t40)
    (= (trace_parameter a4 integer t39 t40) 10)
    (has_parameter a4 categorical t39 t40)
    (= (trace_parameter a4 categorical t39 t40) 2)

    (trace t40 a4 t41)
    (has_parameter a4 categorical t40 t41)
    (= (trace_parameter a4 categorical t40 t41) 3)
    (has_parameter a4 integer t40 t41)
    (= (trace_parameter a4 integer t40 t41) 1)
    ...
    (= (trace_parameter a8 categorical t43 t44) 3)
    (has_parameter a8 integer t43 t44)
    (= (trace_parameter a8 integer t43 t44) 10)

    (trace t44 a1 t45)
    (has_parameter a1 integer t44 t45)
    (= (trace_parameter a1 integer t44 t45) 0)
    (has_parameter a1 categorical t44 t45)
    (= (trace_parameter a1 categorical t44 t45) 3)

    (trace t45 a2 t46)
    (has_parameter a2 integer t45 t46)
    (= (trace_parameter a2 integer t45 t46) 1)
    ...
    (= (trace_parameter a1 integer t47 t48) 41)

    (trace t48 a7 t49)
    (has_parameter a7 categorical t48 t49)
    (= (trace_parameter a7 categorical t48 t49) 1)
    (has_parameter a7 integer t48 t49)
    (= (trace_parameter a7 integer t48 t49) 25)

    (trace t49 a4 t50)
    (has_parameter a4 categorical t49 t50)
    (= (trace_parameter a4 categorical t49 t50) 2)
    (has_parameter a4 integer t49 t50)
    (= (trace_parameter a4 integer t49 t50) 78)

    (trace t50 a2 t51)
    (has_parameter a2 integer t50 t51)
    (= (trace_parameter a2 integer t50 t51) 9)
    (has_parameter a2 categorical t50 t51)
    (= (trace_parameter a2 categorical t50 t51) 2)

    (trace t51 a6 t52)
    (has_parameter a6 integer t51 t52)
    (= (trace_parameter a6 integer t51 t52) 10)
    (has_parameter a6 categorical t51 t52)
    (= (trace_parameter a6 categorical t51 t52) 3)
    ...
    (= (trace_parameter a9 categorical t53 t54) 1)
    ...
    (trace t58 a9 t59)
    (has_parameter a9 categorical t58 t59)
    (= (trace_parameter a9 categorical t58 t59) 3)
    (has_parameter a9 integer t58 t59)
    (= (trace_parameter a9 integer t58 t59) 11)

    (trace t59 a9 t60)
    (has_parameter a9 integer t59 t60)
    (= (trace_parameter a9 integer t59 t60) 10)
    (has_parameter a9 categorical t59 t60)
    (= (trace_parameter a9 categorical t59 t60) 2)

    (trace t60 a5 t61)
    (has_parameter a5 integer t60 t61)
    (= (trace_parameter a5 integer t60 t61) 10)
    ...
    (= (trace_parameter a1 integer t76 t77) 92)

    (trace t77 a1 t78)
    (has_parameter a1 integer t77 t78)
    (= (trace_parameter a1 integer t77 t78) 23)
    ...
    (= (trace_parameter a5 categorical t79 t80) 3)

    (trace t80 a10 t81)
    (has_parameter a10 integer t80 t81)
    (= (trace_parameter a10 integer t80 t81) 4)
    ...
    (= (trace_parameter a4 integer t81 t82) 65)
    ...
    (= (trace_parameter a4 integer t83 t84) 9)
    ...
    (= (trace_parameter a10 categorical t85 t86) 3)
    ...
    (= (trace_parameter a1 integer t87 t88) 6)
    ...
    (= (trace_parameter a1 integer t93 t94) 9)

    (trace t94 a2 t95)
    (has_parameter a2 categorical t94 t95)
    (= (trace_parameter a2 categorical t94 t95) 3)
    ...
    (= (trace_parameter a4 integer t96 t97) 25)
    ...
    (= (trace_parameter a10 integer t97 t98) 24)

    (trace t98 a9 t99)
    (has_parameter a9 integer t98 t99)
    (= (trace_parameter a9 integer t98 t99) 73)
    (has_parameter a9 categorical t98 t99)
    (= (trace_parameter a9 categorical t98 t99) 3)
