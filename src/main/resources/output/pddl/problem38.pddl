(define (problem prob-trace)
  ...
  (:objects
    t76 t10 t6 t91 t66 t33 t70 t61 t79 t53 t1 t49 t69 t81 t15 t54 t28 t38 t44 t40 t27 t34 t26 t39 t62 t13 t90 t96 t14 t35 t64 t71 t22 t51 t21 t47 t80 t17 t30 t32 t25 t65 t57 t5 t19 t68 t16 t59 t82 t18 t50 t92 t58 t94 t56 t37 t85 t97 t45 t83 t78 t84 t87 t8 t2 t24 t31 t46 t11 t67 t98 t55 t41 t89 t72 t75 t23 t77 t74 t86 t12 t48 t95 t43 t36 t7 t73 t3 t29 t52 t60 t88 t93 t42 t0 t63 t4 t20 t9 t99 - trace_state
  ...
  (:init
    ...
    (= (trace_parameter a1 integer t5 t6) 85)
    (has_parameter a1 categorical t5 t6)
    (= (trace_parameter a1 categorical t5 t6) 3)
    ...
    (= (trace_parameter a10 integer t7 t8) 13)

    (trace t8 a1 t9)
    (has_parameter a1 integer t8 t9)
    (= (trace_parameter a1 integer t8 t9) 94)
    ...
    (trace t10 a2 t11)
    (has_parameter a2 categorical t10 t11)
    (= (trace_parameter a2 categorical t10 t11) 3)
    (has_parameter a2 integer t10 t11)
    (= (trace_parameter a2 integer t10 t11) 8)

    (trace t11 a3 t12)
    (has_parameter a3 categorical t11 t12)
    (= (trace_parameter a3 categorical t11 t12) 2)
    (has_parameter a3 integer t11 t12)
    (= (trace_parameter a3 integer t11 t12) 10)
    ...
    (= (trace_parameter a1 integer t13 t14) 5)
    ...
    (= (trace_parameter a10 integer t29 t30) 80)
    ...
    (= (trace_parameter a4 integer t33 t34) 91)
    ...
    (= (trace_parameter a7 categorical t35 t36) 3)
    (has_parameter a7 integer t35 t36)
    (= (trace_parameter a7 integer t35 t36) 28)
    ...
    (= (trace_parameter a3 integer t37 t38) 33)
    (has_parameter a3 categorical t37 t38)
    (= (trace_parameter a3 categorical t37 t38) 2)
    ...
    (= (trace_parameter a1 categorical t39 t40) 3)
    ...
    (= (trace_parameter a3 categorical t41 t42) 2)
    (has_parameter a3 integer t41 t42)
    (= (trace_parameter a3 integer t41 t42) 17)

    (trace t42 a3 t43)
    (has_parameter a3 integer t42 t43)
    (= (trace_parameter a3 integer t42 t43) 0)
    (has_parameter a3 categorical t42 t43)
    (= (trace_parameter a3 categorical t42 t43) 1)

    (trace t43 a2 t44)
    (has_parameter a2 categorical t43 t44)
    (= (trace_parameter a2 categorical t43 t44) 1)
    (has_parameter a2 integer t43 t44)
    (= (trace_parameter a2 integer t43 t44) 33)

    (trace t44 a9 t45)
    (has_parameter a9 categorical t44 t45)
    (= (trace_parameter a9 categorical t44 t45) 3)
    (has_parameter a9 integer t44 t45)
    (= (trace_parameter a9 integer t44 t45) 10)

    (trace t45 a7 t46)
    (has_parameter a7 integer t45 t46)
    (= (trace_parameter a7 integer t45 t46) 25)
    ...
    (= (trace_parameter a9 categorical t50 t51) 3)
    (has_parameter a9 integer t50 t51)
    (= (trace_parameter a9 integer t50 t51) 10)

    (trace t51 a8 t52)
    (has_parameter a8 categorical t51 t52)
    (= (trace_parameter a8 categorical t51 t52) 3)
    (has_parameter a8 integer t51 t52)
    (= (trace_parameter a8 integer t51 t52) 10)

    (trace t52 a5 t53)
    (has_parameter a5 categorical t52 t53)
    (= (trace_parameter a5 categorical t52 t53) 3)
    (has_parameter a5 integer t52 t53)
    (= (trace_parameter a5 integer t52 t53) 9)

    (trace t53 a2 t54)
    (has_parameter a2 categorical t53 t54)
    (= (trace_parameter a2 categorical t53 t54) 3)
    (has_parameter a2 integer t53 t54)
    (= (trace_parameter a2 integer t53 t54) 7)
    ...
    (= (trace_parameter a3 integer t56 t57) 86)
    ...
    (= (trace_parameter a2 integer t58 t59) 57)
    (has_parameter a2 categorical t58 t59)
    (= (trace_parameter a2 categorical t58 t59) 2)

    (trace t59 a5 t60)
    (has_parameter a5 categorical t59 t60)
    (= (trace_parameter a5 categorical t59 t60) 2)
    (has_parameter a5 integer t59 t60)
    (= (trace_parameter a5 integer t59 t60) 2)

    (trace t60 a1 t61)
    (has_parameter a1 integer t60 t61)
    (= (trace_parameter a1 integer t60 t61) 10)
    (has_parameter a1 categorical t60 t61)
    (= (trace_parameter a1 categorical t60 t61) 2)

    (trace t61 a4 t62)
    (has_parameter a4 integer t61 t62)
    (= (trace_parameter a4 integer t61 t62) 10)
    (has_parameter a4 categorical t61 t62)
    (= (trace_parameter a4 categorical t61 t62) 1)

    (trace t62 a10 t63)
    (has_parameter a10 categorical t62 t63)
    (= (trace_parameter a10 categorical t62 t63) 1)
    (has_parameter a10 integer t62 t63)
    (= (trace_parameter a10 integer t62 t63) 2)

    (trace t63 a6 t64)
    (has_parameter a6 integer t63 t64)
    (= (trace_parameter a6 integer t63 t64) 9)
    (has_parameter a6 categorical t63 t64)
    (= (trace_parameter a6 categorical t63 t64) 3)

    (trace t64 a1 t65)
    (has_parameter a1 categorical t64 t65)
    (= (trace_parameter a1 categorical t64 t65) 3)
    (has_parameter a1 integer t64 t65)
    (= (trace_parameter a1 integer t64 t65) 8)
    ...
    (= (trace_parameter a1 integer t66 t67) 0)
    (has_parameter a1 categorical t66 t67)
    (= (trace_parameter a1 categorical t66 t67) 3)

    (trace t67 a4 t68)
    (has_parameter a4 integer t67 t68)
    (= (trace_parameter a4 integer t67 t68) 41)
    ...
    (= (trace_parameter a1 integer t69 t70) 54)

    (trace t70 a3 t71)
    (has_parameter a3 integer t70 t71)
    (= (trace_parameter a3 integer t70 t71) 17)
    ...
    (= (trace_parameter a1 integer t71 t72) 58)
    ...
    (= (trace_parameter a5 integer t73 t74) 10)
    ...
    (= (trace_parameter a5 integer t78 t79) 62)

    (trace t79 a4 t80)
    (has_parameter a4 integer t79 t80)
    (= (trace_parameter a4 integer t79 t80) 35)
    (has_parameter a4 categorical t79 t80)
    (= (trace_parameter a4 categorical t79 t80) 2)

    (trace t80 a3 t81)
    (has_parameter a3 integer t80 t81)
    (= (trace_parameter a3 integer t80 t81) 79)
    (has_parameter a3 categorical t80 t81)
    (= (trace_parameter a3 categorical t80 t81) 1)

    (trace t81 a6 t82)
    (has_parameter a6 integer t81 t82)
    (= (trace_parameter a6 integer t81 t82) 10)
    (has_parameter a6 categorical t81 t82)
    (= (trace_parameter a6 categorical t81 t82) 1)
