(define (problem prob-trace)
  ...
  (:objects
    t28 t25 t79 t45 t11 t16 t55 t69 t90 t95 t6 t21 t82 t89 t93 t41 t30 t68 t49 t13 t73 t2 t43 t83 t18 t59 t76 t67 t50 t29 t44 t47 t84 t34 t96 t85 t0 t62 t91 t42 t51 t74 t27 t72 t14 t97 t53 t8 t60 t92 t31 t81 t70 t86 t17 t33 t48 t65 t56 t1 t87 t26 t23 t54 t36 t15 t3 t20 t88 t71 t7 t32 t61 t78 t37 t10 t39 t24 t38 t9 t64 t77 t98 t99 t40 t4 t35 t22 t5 t63 t80 t58 t57 t66 t52 t75 t19 t46 t12 t94 - trace_state
  ...
  (:init
    ...
    (= (trace_parameter a1 integer t0 t1) 79)

    (trace t1 a9 t2)
    (has_parameter a9 integer t1 t2)
    (= (trace_parameter a9 integer t1 t2) 38)
    (has_parameter a9 categorical t1 t2)
    (= (trace_parameter a9 categorical t1 t2) 3)

    (trace t2 a6 t3)
    (has_parameter a6 integer t2 t3)
    (= (trace_parameter a6 integer t2 t3) 10)
    (has_parameter a6 categorical t2 t3)
    (= (trace_parameter a6 categorical t2 t3) 2)

    (trace t3 a8 t4)
    (has_parameter a8 integer t3 t4)
    (= (trace_parameter a8 integer t3 t4) 72)
    (has_parameter a8 categorical t3 t4)
    (= (trace_parameter a8 categorical t3 t4) 2)

    (trace t4 a2 t5)
    (has_parameter a2 categorical t4 t5)
    (= (trace_parameter a2 categorical t4 t5) 1)
    (has_parameter a2 integer t4 t5)
    (= (trace_parameter a2 integer t4 t5) 11)

    (trace t5 a10 t6)
    (has_parameter a10 integer t5 t6)
    (= (trace_parameter a10 integer t5 t6) 36)
    (has_parameter a10 categorical t5 t6)
    (= (trace_parameter a10 categorical t5 t6) 2)

    (trace t6 a7 t7)
    (has_parameter a7 integer t6 t7)
    (= (trace_parameter a7 integer t6 t7) 73)
    ...
    (= (trace_parameter a8 integer t7 t8) 10)

    (trace t8 a4 t9)
    (has_parameter a4 categorical t8 t9)
    (= (trace_parameter a4 categorical t8 t9) 1)
    (has_parameter a4 integer t8 t9)
    (= (trace_parameter a4 integer t8 t9) 70)
    ...
    (= (trace_parameter a10 categorical t11 t12) 3)
    ...
    (= (trace_parameter a3 categorical t27 t28) 2)
    ...
    (= (trace_parameter a1 integer t32 t33) 26)

    (trace t33 a9 t34)
    (has_parameter a9 categorical t33 t34)
    (= (trace_parameter a9 categorical t33 t34) 1)
    (has_parameter a9 integer t33 t34)
    (= (trace_parameter a9 integer t33 t34) 72)

    (trace t34 a2 t35)
    (has_parameter a2 integer t34 t35)
    (= (trace_parameter a2 integer t34 t35) 83)
    ...
    (= (trace_parameter a4 categorical t44 t45) 1)
    (has_parameter a4 integer t44 t45)
    (= (trace_parameter a4 integer t44 t45) 78)
    ...
    (= (trace_parameter a7 integer t46 t47) 97)
    (has_parameter a7 categorical t46 t47)
    (= (trace_parameter a7 categorical t46 t47) 2)

    (trace t47 a10 t48)
    (has_parameter a10 integer t47 t48)
    (= (trace_parameter a10 integer t47 t48) 47)
    ...
    (= (trace_parameter a6 integer t52 t53) 10)
    ...
    (trace t54 a4 t55)
    (has_parameter a4 categorical t54 t55)
    (= (trace_parameter a4 categorical t54 t55) 2)
    (has_parameter a4 integer t54 t55)
    (= (trace_parameter a4 integer t54 t55) 10)

    (trace t55 a5 t56)
    (has_parameter a5 categorical t55 t56)
    (= (trace_parameter a5 categorical t55 t56) 2)
    (has_parameter a5 integer t55 t56)
    (= (trace_parameter a5 integer t55 t56) 31)

    (trace t56 a5 t57)
    (has_parameter a5 integer t56 t57)
    (= (trace_parameter a5 integer t56 t57) 1)
    (has_parameter a5 categorical t56 t57)
    (= (trace_parameter a5 categorical t56 t57) 2)

    (trace t57 a1 t58)
    (has_parameter a1 integer t57 t58)
    (= (trace_parameter a1 integer t57 t58) 98)
    ...
    (trace t60 a10 t61)
    (has_parameter a10 integer t60 t61)
    (= (trace_parameter a10 integer t60 t61) 10)
    (has_parameter a10 categorical t60 t61)
    (= (trace_parameter a10 categorical t60 t61) 1)

    (trace t61 a8 t62)
    (has_parameter a8 integer t61 t62)
    (= (trace_parameter a8 integer t61 t62) 10)
    ...
    (= (trace_parameter a10 integer t62 t63) 66)

    (trace t63 a1 t64)
    (has_parameter a1 integer t63 t64)
    (= (trace_parameter a1 integer t63 t64) 15)
    (has_parameter a1 categorical t63 t64)
    (= (trace_parameter a1 categorical t63 t64) 2)

    (trace t64 a10 t65)
    (has_parameter a10 categorical t64 t65)
    (= (trace_parameter a10 categorical t64 t65) 1)
    (has_parameter a10 integer t64 t65)
    (= (trace_parameter a10 integer t64 t65) 8)

    (trace t65 a9 t66)
    (has_parameter a9 categorical t65 t66)
    (= (trace_parameter a9 categorical t65 t66) 1)
    (has_parameter a9 integer t65 t66)
    (= (trace_parameter a9 integer t65 t66) 10)

    (trace t66 a8 t67)
    (has_parameter a8 categorical t66 t67)
    (= (trace_parameter a8 categorical t66 t67) 3)
    (has_parameter a8 integer t66 t67)
    (= (trace_parameter a8 integer t66 t67) 10)

    (trace t67 a2 t68)
    (has_parameter a2 categorical t67 t68)
    (= (trace_parameter a2 categorical t67 t68) 3)
    (has_parameter a2 integer t67 t68)
    (= (trace_parameter a2 integer t67 t68) 8)

    (trace t68 a5 t69)
    (has_parameter a5 categorical t68 t69)
    (= (trace_parameter a5 categorical t68 t69) 1)
    (has_parameter a5 integer t68 t69)
    (= (trace_parameter a5 integer t68 t69) 2)

    (trace t69 a6 t70)
    (has_parameter a6 categorical t69 t70)
    (= (trace_parameter a6 categorical t69 t70) 1)
    (has_parameter a6 integer t69 t70)
    (= (trace_parameter a6 integer t69 t70) 10)

    (trace t70 a10 t71)
    (has_parameter a10 categorical t70 t71)
    (= (trace_parameter a10 categorical t70 t71) 1)
    (has_parameter a10 integer t70 t71)
    (= (trace_parameter a10 integer t70 t71) 10)
    ...
    (= (trace_parameter a5 integer t72 t73) 59)
    ...
    (= (trace_parameter a4 integer t84 t85) 84)

    (trace t85 a6 t86)
    (has_parameter a6 integer t85 t86)
    (= (trace_parameter a6 integer t85 t86) 1)
    (has_parameter a6 categorical t85 t86)
    (= (trace_parameter a6 categorical t85 t86) 3)
    ...
    (= (trace_parameter a1 integer t87 t88) 8)
    ...
    (= (trace_parameter a2 integer t88 t89) 10)

    (trace t89 a2 t90)
    (has_parameter a2 integer t89 t90)
    (= (trace_parameter a2 integer t89 t90) 9)
