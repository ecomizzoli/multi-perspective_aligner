(define (problem prob-trace)
  ...
  (:objects
    t97 t2 t87 t11 t74 t94 t67 t14 t43 t1 t79 t46 t95 t55 t72 t32 t98 t99 t75 t71 t62 t77 t88 t36 t92 t21 t70 t13 t66 t0 t44 t78 t15 t54 t59 t48 t47 t30 t81 t45 t49 t25 t96 t80 t19 t83 t63 t4 t89 t12 t64 t26 t23 t56 t52 t82 t37 t90 t6 t91 t17 t65 t69 t85 t76 t93 t31 t7 t33 t16 t84 t86 t5 t8 t41 t39 t50 t29 t10 t68 t3 t34 t57 t42 t28 t38 t35 t24 t61 t27 t9 t18 t22 t60 t58 t51 t73 t40 t20 t53 - trace_state
  ...
  (:init
    ...
    (= (trace_parameter a6 integer t10 t11) 10)
    ...
    (= (trace_parameter a5 integer t15 t16) 5)

    (trace t16 a8 t17)
    (has_parameter a8 integer t16 t17)
    (= (trace_parameter a8 integer t16 t17) 8)
    (has_parameter a8 categorical t16 t17)
    (= (trace_parameter a8 categorical t16 t17) 2)

    (trace t17 a10 t18)
    (has_parameter a10 categorical t17 t18)
    (= (trace_parameter a10 categorical t17 t18) 1)
    (has_parameter a10 integer t17 t18)
    (= (trace_parameter a10 integer t17 t18) 91)
    ...
    (= (trace_parameter a7 integer t23 t24) 27)

    (trace t24 a5 t25)
    (has_parameter a5 integer t24 t25)
    (= (trace_parameter a5 integer t24 t25) 4)
    ...
    (trace t26 a7 t27)
    (has_parameter a7 integer t26 t27)
    (= (trace_parameter a7 integer t26 t27) 0)
    (has_parameter a7 categorical t26 t27)
    (= (trace_parameter a7 categorical t26 t27) 3)

    (trace t27 a9 t28)
    (has_parameter a9 integer t27 t28)
    (= (trace_parameter a9 integer t27 t28) 59)
    (has_parameter a9 categorical t27 t28)
    (= (trace_parameter a9 categorical t27 t28) 2)

    (trace t28 a6 t29)
    (has_parameter a6 categorical t28 t29)
    (= (trace_parameter a6 categorical t28 t29) 1)
    (has_parameter a6 integer t28 t29)
    (= (trace_parameter a6 integer t28 t29) 0)

    (trace t29 a9 t30)
    (has_parameter a9 integer t29 t30)
    (= (trace_parameter a9 integer t29 t30) 40)
    (has_parameter a9 categorical t29 t30)
    (= (trace_parameter a9 categorical t29 t30) 1)

    (trace t30 a4 t31)
    (has_parameter a4 categorical t30 t31)
    (= (trace_parameter a4 categorical t30 t31) 2)
    (has_parameter a4 integer t30 t31)
    (= (trace_parameter a4 integer t30 t31) 9)

    (trace t31 a5 t32)
    (has_parameter a5 categorical t31 t32)
    (= (trace_parameter a5 categorical t31 t32) 2)
    ...
    (= (trace_parameter a4 integer t35 t36) 81)

    (trace t36 a3 t37)
    (has_parameter a3 integer t36 t37)
    (= (trace_parameter a3 integer t36 t37) 10)
    ...
    (= (trace_parameter a4 integer t38 t39) 13)
    (has_parameter a4 categorical t38 t39)
    (= (trace_parameter a4 categorical t38 t39) 2)

    (trace t39 a3 t40)
    (has_parameter a3 categorical t39 t40)
    (= (trace_parameter a3 categorical t39 t40) 1)
    (has_parameter a3 integer t39 t40)
    (= (trace_parameter a3 integer t39 t40) 10)

    (trace t40 a7 t41)
    (has_parameter a7 integer t40 t41)
    (= (trace_parameter a7 integer t40 t41) 0)
    (has_parameter a7 categorical t40 t41)
    (= (trace_parameter a7 categorical t40 t41) 1)
    ...
    (= (trace_parameter a10 integer t42 t43) 45)
    ...
    (= (trace_parameter a4 categorical t46 t47) 2)

    (trace t47 a2 t48)
    (has_parameter a2 categorical t47 t48)
    (= (trace_parameter a2 categorical t47 t48) 1)
    (has_parameter a2 integer t47 t48)
    (= (trace_parameter a2 integer t47 t48) 100)

    (trace t48 a2 t49)
    (has_parameter a2 integer t48 t49)
    (= (trace_parameter a2 integer t48 t49) 9)
    (has_parameter a2 categorical t48 t49)
    (= (trace_parameter a2 categorical t48 t49) 2)

    (trace t49 a10 t50)
    (has_parameter a10 categorical t49 t50)
    (= (trace_parameter a10 categorical t49 t50) 2)
    (has_parameter a10 integer t49 t50)
    (= (trace_parameter a10 integer t49 t50) 2)

    (trace t50 a5 t51)
    (has_parameter a5 categorical t50 t51)
    (= (trace_parameter a5 categorical t50 t51) 3)
    (has_parameter a5 integer t50 t51)
    (= (trace_parameter a5 integer t50 t51) 76)
    ...
    (= (trace_parameter a9 categorical t52 t53) 3)
    (has_parameter a9 integer t52 t53)
    (= (trace_parameter a9 integer t52 t53) 30)
    ...
    (trace t54 a8 t55)
    (has_parameter a8 categorical t54 t55)
    (= (trace_parameter a8 categorical t54 t55) 2)
    (has_parameter a8 integer t54 t55)
    (= (trace_parameter a8 integer t54 t55) 76)

    (trace t55 a2 t56)
    (has_parameter a2 integer t55 t56)
    (= (trace_parameter a2 integer t55 t56) 72)
    (has_parameter a2 categorical t55 t56)
    (= (trace_parameter a2 categorical t55 t56) 2)

    (trace t56 a9 t57)
    (has_parameter a9 integer t56 t57)
    (= (trace_parameter a9 integer t56 t57) 10)
    (has_parameter a9 categorical t56 t57)
    (= (trace_parameter a9 categorical t56 t57) 2)

    (trace t57 a1 t58)
    (has_parameter a1 categorical t57 t58)
    (= (trace_parameter a1 categorical t57 t58) 3)
    (has_parameter a1 integer t57 t58)
    (= (trace_parameter a1 integer t57 t58) 93)

    (trace t58 a5 t59)
    (has_parameter a5 integer t58 t59)
    (= (trace_parameter a5 integer t58 t59) 31)
    ...
    (= (trace_parameter a7 integer t59 t60) 12)

    (trace t60 a3 t61)
    (has_parameter a3 categorical t60 t61)
    (= (trace_parameter a3 categorical t60 t61) 3)
    (has_parameter a3 integer t60 t61)
    (= (trace_parameter a3 integer t60 t61) 99)

    (trace t61 a7 t62)
    (has_parameter a7 integer t61 t62)
    (= (trace_parameter a7 integer t61 t62) 10)
    (has_parameter a7 categorical t61 t62)
    (= (trace_parameter a7 categorical t61 t62) 1)

    (trace t62 a5 t63)
    (has_parameter a5 integer t62 t63)
    (= (trace_parameter a5 integer t62 t63) 30)
    (has_parameter a5 categorical t62 t63)
    (= (trace_parameter a5 categorical t62 t63) 3)

    (trace t63 a2 t64)
    (has_parameter a2 integer t63 t64)
    (= (trace_parameter a2 integer t63 t64) 53)
    (has_parameter a2 categorical t63 t64)
    (= (trace_parameter a2 categorical t63 t64) 2)

    (trace t64 a3 t65)
    (has_parameter a3 categorical t64 t65)
    (= (trace_parameter a3 categorical t64 t65) 2)
    (has_parameter a3 integer t64 t65)
    (= (trace_parameter a3 integer t64 t65) 32)

    (trace t65 a9 t66)
    (has_parameter a9 categorical t65 t66)
    (= (trace_parameter a9 categorical t65 t66) 3)
    (has_parameter a9 integer t65 t66)
    (= (trace_parameter a9 integer t65 t66) 35)

    (trace t66 a10 t67)
    (has_parameter a10 integer t66 t67)
    (= (trace_parameter a10 integer t66 t67) 31)
    (has_parameter a10 categorical t66 t67)
    (= (trace_parameter a10 categorical t66 t67) 2)
    ...
    (= (trace_parameter a4 categorical t71 t72) 3)
    (has_parameter a4 integer t71 t72)
    (= (trace_parameter a4 integer t71 t72) 94)
    ...
    (= (trace_parameter a7 integer t73 t74) 65)

    (trace t74 a9 t75)
    (has_parameter a9 integer t74 t75)
    (= (trace_parameter a9 integer t74 t75) 58)
    (has_parameter a9 categorical t74 t75)
    (= (trace_parameter a9 categorical t74 t75) 1)

    (trace t75 a8 t76)
    (has_parameter a8 integer t75 t76)
    (= (trace_parameter a8 integer t75 t76) 0)
    (has_parameter a8 categorical t75 t76)
    (= (trace_parameter a8 categorical t75 t76) 3)

    (trace t76 a4 t77)
    (has_parameter a4 integer t76 t77)
    (= (trace_parameter a4 integer t76 t77) 29)
    (has_parameter a4 categorical t76 t77)
    (= (trace_parameter a4 categorical t76 t77) 2)

    (trace t77 a1 t78)
    (has_parameter a1 integer t77 t78)
    (= (trace_parameter a1 integer t77 t78) 75)
    (has_parameter a1 categorical t77 t78)
    (= (trace_parameter a1 categorical t77 t78) 2)

    (trace t78 a2 t79)
    (has_parameter a2 integer t78 t79)
    (= (trace_parameter a2 integer t78 t79) 10)
    (has_parameter a2 categorical t78 t79)
    (= (trace_parameter a2 categorical t78 t79) 3)

    (trace t79 a1 t80)
    (has_parameter a1 integer t79 t80)
    (= (trace_parameter a1 integer t79 t80) 8)
    ...
    (= (trace_parameter a3 integer t80 t81) 0)
    ...
    (trace t82 a4 t83)
    (has_parameter a4 integer t82 t83)
    (= (trace_parameter a4 integer t82 t83) 0)
    (has_parameter a4 categorical t82 t83)
    (= (trace_parameter a4 categorical t82 t83) 2)

    (trace t83 a2 t84)
    (has_parameter a2 categorical t83 t84)
    (= (trace_parameter a2 categorical t83 t84) 2)
    (has_parameter a2 integer t83 t84)
    (= (trace_parameter a2 integer t83 t84) 71)

    (trace t84 a10 t85)
    (has_parameter a10 categorical t84 t85)
    (= (trace_parameter a10 categorical t84 t85) 2)
    (has_parameter a10 integer t84 t85)
    (= (trace_parameter a10 integer t84 t85) 52)

    (trace t85 a3 t86)
    (has_parameter a3 integer t85 t86)
    (= (trace_parameter a3 integer t85 t86) 4)
    ...
    (= (trace_parameter a4 integer t86 t87) 78)

    (trace t87 a2 t88)
    (has_parameter a2 categorical t87 t88)
    (= (trace_parameter a2 categorical t87 t88) 1)
    (has_parameter a2 integer t87 t88)
    (= (trace_parameter a2 integer t87 t88) 16)

    (trace t88 a3 t89)
    (has_parameter a3 categorical t88 t89)
    (= (trace_parameter a3 categorical t88 t89) 2)
    (has_parameter a3 integer t88 t89)
    (= (trace_parameter a3 integer t88 t89) 1)

    (trace t89 a9 t90)
    (has_parameter a9 integer t89 t90)
    (= (trace_parameter a9 integer t89 t90) 10)
    (has_parameter a9 categorical t89 t90)
    (= (trace_parameter a9 categorical t89 t90) 2)

    (trace t90 a2 t91)
    (has_parameter a2 integer t90 t91)
    (= (trace_parameter a2 integer t90 t91) 10)
    (has_parameter a2 categorical t90 t91)
    (= (trace_parameter a2 categorical t90 t91) 2)

    (trace t91 a10 t92)
    (has_parameter a10 integer t91 t92)
    (= (trace_parameter a10 integer t91 t92) 1)
    (has_parameter a10 categorical t91 t92)
    (= (trace_parameter a10 categorical t91 t92) 3)

    (trace t92 a2 t93)
    (has_parameter a2 integer t92 t93)
    (= (trace_parameter a2 integer t92 t93) 9)
    (has_parameter a2 categorical t92 t93)
    (= (trace_parameter a2 categorical t92 t93) 1)

    (trace t93 a5 t94)
    (has_parameter a5 integer t93 t94)
    (= (trace_parameter a5 integer t93 t94) 39)
    (has_parameter a5 categorical t93 t94)
    (= (trace_parameter a5 categorical t93 t94) 1)

    (trace t94 a3 t95)
    (has_parameter a3 categorical t94 t95)
    (= (trace_parameter a3 categorical t94 t95) 2)
    (has_parameter a3 integer t94 t95)
    (= (trace_parameter a3 integer t94 t95) 93)

    (trace t95 a1 t96)
    (has_parameter a1 integer t95 t96)
    (= (trace_parameter a1 integer t95 t96) 7)
    (has_parameter a1 categorical t95 t96)
    (= (trace_parameter a1 categorical t95 t96) 3)

    (trace t96 a10 t97)
    (has_parameter a10 categorical t96 t97)
    (= (trace_parameter a10 categorical t96 t97) 2)
    (has_parameter a10 integer t96 t97)
    (= (trace_parameter a10 integer t96 t97) 10)

    (trace t97 a3 t98)
    (has_parameter a3 integer t97 t98)
    (= (trace_parameter a3 integer t97 t98) 90)
    ...
    (= (trace_parameter a6 integer t98 t99) 0)
