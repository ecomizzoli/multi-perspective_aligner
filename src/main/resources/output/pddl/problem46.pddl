(define (problem prob-trace)
  ...
  (:objects
    t20 t6 t28 t50 t24 t99 t1 t45 t55 t35 t87 t84 t71 t96 t7 t79 t29 t72 t67 t92 t43 t70 t54 t64 t86 t91 t41 t76 t59 t78 t30 t48 t40 t94 t14 t89 t36 t74 t93 t26 t0 t11 t44 t22 t98 t15 t83 t88 t8 t52 t53 t19 t66 t61 t12 t68 t63 t62 t58 t5 t80 t18 t38 t33 t23 t65 t69 t10 t95 t3 t81 t21 t27 t60 t85 t39 t31 t57 t42 t47 t56 t37 t90 t34 t51 t77 t97 t49 t17 t32 t2 t16 t73 t9 t75 t46 t4 t25 t13 t82 - trace_state
  ...
  (:init
    ...
    (= (trace_parameter a3 integer t1 t2) 56)
    (has_parameter a3 categorical t1 t2)
    (= (trace_parameter a3 categorical t1 t2) 1)

    (trace t2 a5 t3)
    (has_parameter a5 categorical t2 t3)
    (= (trace_parameter a5 categorical t2 t3) 2)
    ...
    (= (trace_parameter a4 integer t3 t4) 10)

    (trace t4 a1 t5)
    (has_parameter a1 integer t4 t5)
    (= (trace_parameter a1 integer t4 t5) 80)
    ...
    (= (trace_parameter a3 integer t5 t6) 86)

    (trace t6 a4 t7)
    (has_parameter a4 categorical t6 t7)
    (= (trace_parameter a4 categorical t6 t7) 1)
    (has_parameter a4 integer t6 t7)
    (= (trace_parameter a4 integer t6 t7) 29)

    (trace t7 a1 t8)
    (has_parameter a1 integer t7 t8)
    (= (trace_parameter a1 integer t7 t8) 10)
    (has_parameter a1 categorical t7 t8)
    (= (trace_parameter a1 categorical t7 t8) 2)

    (trace t8 a4 t9)
    (has_parameter a4 categorical t8 t9)
    (= (trace_parameter a4 categorical t8 t9) 2)
    (has_parameter a4 integer t8 t9)
    (= (trace_parameter a4 integer t8 t9) 0)
    ...
    (trace t10 a6 t11)
    (has_parameter a6 categorical t10 t11)
    (= (trace_parameter a6 categorical t10 t11) 2)
    (has_parameter a6 integer t10 t11)
    (= (trace_parameter a6 integer t10 t11) 1)

    (trace t11 a9 t12)
    (has_parameter a9 categorical t11 t12)
    (= (trace_parameter a9 categorical t11 t12) 2)
    (has_parameter a9 integer t11 t12)
    (= (trace_parameter a9 integer t11 t12) 4)
    ...
    (trace t13 a7 t14)
    (has_parameter a7 categorical t13 t14)
    (= (trace_parameter a7 categorical t13 t14) 2)
    (has_parameter a7 integer t13 t14)
    (= (trace_parameter a7 integer t13 t14) 7)

    (trace t14 a7 t15)
    (has_parameter a7 categorical t14 t15)
    (= (trace_parameter a7 categorical t14 t15) 2)
    (has_parameter a7 integer t14 t15)
    (= (trace_parameter a7 integer t14 t15) 10)

    (trace t15 a7 t16)
    (has_parameter a7 integer t15 t16)
    (= (trace_parameter a7 integer t15 t16) 9)
    (has_parameter a7 categorical t15 t16)
    (= (trace_parameter a7 categorical t15 t16) 2)
    ...
    (= (trace_parameter a3 integer t17 t18) 10)

    (trace t18 a2 t19)
    (has_parameter a2 integer t18 t19)
    (= (trace_parameter a2 integer t18 t19) 9)
    (has_parameter a2 categorical t18 t19)
    (= (trace_parameter a2 categorical t18 t19) 2)

    (trace t19 a5 t20)
    (has_parameter a5 integer t19 t20)
    (= (trace_parameter a5 integer t19 t20) 34)
    (has_parameter a5 categorical t19 t20)
    (= (trace_parameter a5 categorical t19 t20) 2)

    (trace t20 a4 t21)
    (has_parameter a4 categorical t20 t21)
    (= (trace_parameter a4 categorical t20 t21) 2)
    (has_parameter a4 integer t20 t21)
    (= (trace_parameter a4 integer t20 t21) 98)

    (trace t21 a9 t22)
    (has_parameter a9 integer t21 t22)
    (= (trace_parameter a9 integer t21 t22) 54)
    (has_parameter a9 categorical t21 t22)
    (= (trace_parameter a9 categorical t21 t22) 1)

    (trace t22 a6 t23)
    (has_parameter a6 categorical t22 t23)
    (= (trace_parameter a6 categorical t22 t23) 2)
    (has_parameter a6 integer t22 t23)
    (= (trace_parameter a6 integer t22 t23) 10)

    (trace t23 a10 t24)
    (has_parameter a10 categorical t23 t24)
    (= (trace_parameter a10 categorical t23 t24) 2)
    (has_parameter a10 integer t23 t24)
    (= (trace_parameter a10 integer t23 t24) 23)

    (trace t24 a7 t25)
    (has_parameter a7 categorical t24 t25)
    (= (trace_parameter a7 categorical t24 t25) 2)
    (has_parameter a7 integer t24 t25)
    (= (trace_parameter a7 integer t24 t25) 60)

    (trace t25 a1 t26)
    (has_parameter a1 integer t25 t26)
    (= (trace_parameter a1 integer t25 t26) 13)
    (has_parameter a1 categorical t25 t26)
    (= (trace_parameter a1 categorical t25 t26) 2)

    (trace t26 a3 t27)
    (has_parameter a3 categorical t26 t27)
    (= (trace_parameter a3 categorical t26 t27) 1)
    (has_parameter a3 integer t26 t27)
    (= (trace_parameter a3 integer t26 t27) 8)

    (trace t27 a1 t28)
    (has_parameter a1 categorical t27 t28)
    (= (trace_parameter a1 categorical t27 t28) 2)
    (has_parameter a1 integer t27 t28)
    (= (trace_parameter a1 integer t27 t28) 10)

    (trace t28 a9 t29)
    (has_parameter a9 categorical t28 t29)
    (= (trace_parameter a9 categorical t28 t29) 2)
    (has_parameter a9 integer t28 t29)
    (= (trace_parameter a9 integer t28 t29) 11)

    (trace t29 a8 t30)
    (has_parameter a8 integer t29 t30)
    (= (trace_parameter a8 integer t29 t30) 16)
    (has_parameter a8 categorical t29 t30)
    (= (trace_parameter a8 categorical t29 t30) 2)

    (trace t30 a10 t31)
    (has_parameter a10 categorical t30 t31)
    (= (trace_parameter a10 categorical t30 t31) 1)
    (has_parameter a10 integer t30 t31)
    (= (trace_parameter a10 integer t30 t31) 100)
    ...
    (= (trace_parameter a9 integer t32 t33) 0)
    ...
    (= (trace_parameter a9 categorical t34 t35) 1)
    (has_parameter a9 integer t34 t35)
    (= (trace_parameter a9 integer t34 t35) 38)

    (trace t35 a10 t36)
    (has_parameter a10 categorical t35 t36)
    (= (trace_parameter a10 categorical t35 t36) 2)
    (has_parameter a10 integer t35 t36)
    (= (trace_parameter a10 integer t35 t36) 14)

    (trace t36 a4 t37)
    (has_parameter a4 integer t36 t37)
    (= (trace_parameter a4 integer t36 t37) 56)
    (has_parameter a4 categorical t36 t37)
    (= (trace_parameter a4 categorical t36 t37) 1)

    (trace t37 a5 t38)
    (has_parameter a5 categorical t37 t38)
    (= (trace_parameter a5 categorical t37 t38) 1)
    (has_parameter a5 integer t37 t38)
    (= (trace_parameter a5 integer t37 t38) 10)

    (trace t38 a2 t39)
    (has_parameter a2 integer t38 t39)
    (= (trace_parameter a2 integer t38 t39) 0)
    (has_parameter a2 categorical t38 t39)
    (= (trace_parameter a2 categorical t38 t39) 1)

    (trace t39 a9 t40)
    (has_parameter a9 integer t39 t40)
    (= (trace_parameter a9 integer t39 t40) 12)
    ...
    (= (trace_parameter a8 integer t49 t50) 1)
    ...
    (= (trace_parameter a9 categorical t52 t53) 1)
    (has_parameter a9 integer t52 t53)
    (= (trace_parameter a9 integer t52 t53) 87)

    (trace t53 a1 t54)
    (has_parameter a1 integer t53 t54)
    (= (trace_parameter a1 integer t53 t54) 66)
    ...
    (= (trace_parameter a3 integer t54 t55) 89)
    ...
    (= (trace_parameter a2 integer t58 t59) 34)

    (trace t59 a9 t60)
    (has_parameter a9 categorical t59 t60)
    (= (trace_parameter a9 categorical t59 t60) 2)
    (has_parameter a9 integer t59 t60)
    (= (trace_parameter a9 integer t59 t60) 79)

    (trace t60 a2 t61)
    (has_parameter a2 categorical t60 t61)
    (= (trace_parameter a2 categorical t60 t61) 1)
    (has_parameter a2 integer t60 t61)
    (= (trace_parameter a2 integer t60 t61) 4)

    (trace t61 a4 t62)
    (has_parameter a4 categorical t61 t62)
    (= (trace_parameter a4 categorical t61 t62) 2)
    (has_parameter a4 integer t61 t62)
    (= (trace_parameter a4 integer t61 t62) 84)

    (trace t62 a3 t63)
    (has_parameter a3 integer t62 t63)
    (= (trace_parameter a3 integer t62 t63) 5)
    (has_parameter a3 categorical t62 t63)
    (= (trace_parameter a3 categorical t62 t63) 1)

    (trace t63 a4 t64)
    (has_parameter a4 integer t63 t64)
    (= (trace_parameter a4 integer t63 t64) 92)
    ...
    (= (trace_parameter a9 integer t65 t66) 0)

    (trace t66 a1 t67)
    (has_parameter a1 integer t66 t67)
    (= (trace_parameter a1 integer t66 t67) 19)
    (has_parameter a1 categorical t66 t67)
    (= (trace_parameter a1 categorical t66 t67) 2)

    (trace t67 a5 t68)
    (has_parameter a5 categorical t67 t68)
    (= (trace_parameter a5 categorical t67 t68) 2)
    (has_parameter a5 integer t67 t68)
    (= (trace_parameter a5 integer t67 t68) 10)
    ...
    (= (trace_parameter a9 categorical t97 t98) 2)

    (trace t98 a8 t99)
    (has_parameter a8 integer t98 t99)
    (= (trace_parameter a8 integer t98 t99) 65)
    (has_parameter a8 categorical t98 t99)
    (= (trace_parameter a8 categorical t98 t99) 2)
