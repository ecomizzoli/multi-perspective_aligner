(define (problem prob-trace)
  ...
  (:objects
    t58 t70 t77 t44 t57 t39 t99 t26 t38 t90 t96 t15 t23 t54 t86 t88 t51 t50 t34 t14 t94 t42 t98 t69 t31 t45 t21 t75 t22 t63 t0 t66 t1 t4 t37 t87 t17 t19 t52 t60 t83 t35 t97 t68 t30 t93 t27 t29 t91 t18 t71 t82 t95 t62 t65 t74 t7 t33 t40 t61 t72 t20 t67 t89 t53 t10 t3 t2 t6 t55 t11 t12 t9 t5 t78 t79 t80 t32 t73 t64 t13 t84 t16 t43 t59 t49 t85 t76 t47 t41 t8 t25 t48 t46 t81 t92 t24 t28 t56 t36 - trace_state
  ...
  (:init
    ...
    (= (trace_parameter a5 integer t4 t5) 55)
    ...
    (= (trace_parameter a4 integer t6 t7) 2)

    (trace t7 a5 t8)
    (has_parameter a5 categorical t7 t8)
    (= (trace_parameter a5 categorical t7 t8) 1)
    ...
    (= (trace_parameter a5 integer t11 t12) 21)
    ...
    (= (trace_parameter a1 integer t13 t14) 38)

    (trace t14 a2 t15)
    (has_parameter a2 integer t14 t15)
    (= (trace_parameter a2 integer t14 t15) 6)
    ...
    (= (trace_parameter a1 integer t15 t16) 40)

    (trace t16 a10 t17)
    (has_parameter a10 integer t16 t17)
    (= (trace_parameter a10 integer t16 t17) 15)
    (has_parameter a10 categorical t16 t17)
    (= (trace_parameter a10 categorical t16 t17) 3)
    ...
    (= (trace_parameter a4 integer t23 t24) 75)
    ...
    (= (trace_parameter a4 integer t26 t27) 7)

    (trace t27 a3 t28)
    (has_parameter a3 integer t27 t28)
    (= (trace_parameter a3 integer t27 t28) 91)
    (has_parameter a3 categorical t27 t28)
    (= (trace_parameter a3 categorical t27 t28) 2)

    (trace t28 a6 t29)
    (has_parameter a6 categorical t28 t29)
    (= (trace_parameter a6 categorical t28 t29) 2)
    (has_parameter a6 integer t28 t29)
    (= (trace_parameter a6 integer t28 t29) 0)

    (trace t29 a3 t30)
    (has_parameter a3 integer t29 t30)
    (= (trace_parameter a3 integer t29 t30) 10)
    (has_parameter a3 categorical t29 t30)
    (= (trace_parameter a3 categorical t29 t30) 2)
    ...
    (= (trace_parameter a9 integer t36 t37) 50)

    (trace t37 a6 t38)
    (has_parameter a6 integer t37 t38)
    (= (trace_parameter a6 integer t37 t38) 6)
    (has_parameter a6 categorical t37 t38)
    (= (trace_parameter a6 categorical t37 t38) 2)

    (trace t38 a10 t39)
    (has_parameter a10 integer t38 t39)
    (= (trace_parameter a10 integer t38 t39) 36)
    ...
    (= (trace_parameter a1 integer t39 t40) 22)

    (trace t40 a9 t41)
    (has_parameter a9 integer t40 t41)
    (= (trace_parameter a9 integer t40 t41) 61)
    (has_parameter a9 categorical t40 t41)
    (= (trace_parameter a9 categorical t40 t41) 3)
    ...
    (= (trace_parameter a10 integer t43 t44) 80)
    ...
    (= (trace_parameter a7 categorical t45 t46) 1)
    (has_parameter a7 integer t45 t46)
    (= (trace_parameter a7 integer t45 t46) 72)

    (trace t46 a3 t47)
    (has_parameter a3 categorical t46 t47)
    (= (trace_parameter a3 categorical t46 t47) 3)
    (has_parameter a3 integer t46 t47)
    (= (trace_parameter a3 integer t46 t47) 70)

    (trace t47 a1 t48)
    (has_parameter a1 integer t47 t48)
    (= (trace_parameter a1 integer t47 t48) 9)
    (has_parameter a1 categorical t47 t48)
    (= (trace_parameter a1 categorical t47 t48) 3)

    (trace t48 a5 t49)
    (has_parameter a5 categorical t48 t49)
    (= (trace_parameter a5 categorical t48 t49) 3)
    (has_parameter a5 integer t48 t49)
    (= (trace_parameter a5 integer t48 t49) 78)

    (trace t49 a10 t50)
    (has_parameter a10 integer t49 t50)
    (= (trace_parameter a10 integer t49 t50) 10)
    (has_parameter a10 categorical t49 t50)
    (= (trace_parameter a10 categorical t49 t50) 1)

    (trace t50 a3 t51)
    (has_parameter a3 integer t50 t51)
    (= (trace_parameter a3 integer t50 t51) 4)
    ...
    (= (trace_parameter a7 integer t51 t52) 100)
    ...
    (= (trace_parameter a1 integer t65 t66) 76)
    ...
    (= (trace_parameter a5 integer t71 t72) 9)
    ...
    (= (trace_parameter a10 integer t72 t73) 13)
    ...
    (trace t74 a6 t75)
    (has_parameter a6 integer t74 t75)
    (= (trace_parameter a6 integer t74 t75) 8)
    (has_parameter a6 categorical t74 t75)
    (= (trace_parameter a6 categorical t74 t75) 3)

    (trace t75 a10 t76)
    (has_parameter a10 integer t75 t76)
    (= (trace_parameter a10 integer t75 t76) 10)
    (has_parameter a10 categorical t75 t76)
    (= (trace_parameter a10 categorical t75 t76) 3)

    (trace t76 a7 t77)
    (has_parameter a7 integer t76 t77)
    (= (trace_parameter a7 integer t76 t77) 5)
    (has_parameter a7 categorical t76 t77)
    (= (trace_parameter a7 categorical t76 t77) 3)

    (trace t77 a5 t78)
    (has_parameter a5 integer t77 t78)
    (= (trace_parameter a5 integer t77 t78) 82)
    (has_parameter a5 categorical t77 t78)
    (= (trace_parameter a5 categorical t77 t78) 3)

    (trace t78 a1 t79)
    (has_parameter a1 integer t78 t79)
    (= (trace_parameter a1 integer t78 t79) 42)
    (has_parameter a1 categorical t78 t79)
    (= (trace_parameter a1 categorical t78 t79) 2)
