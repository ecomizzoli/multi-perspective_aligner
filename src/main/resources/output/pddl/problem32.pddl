(define (problem prob-trace)
  ...
  (:objects
    t86 t12 t98 t97 t83 t41 t4 t22 t1 t60 t64 t45 t58 t68 t7 t59 t3 t27 t44 t6 t13 t61 t69 t2 t47 t0 t65 t11 t72 t30 t52 t46 t15 t29 t19 t25 t93 t63 t33 t85 t90 t23 t95 t28 t48 t40 t56 t16 t37 t82 t92 t96 t81 t8 t17 t62 t77 t99 t26 t57 t10 t79 t76 t5 t67 t14 t71 t74 t21 t18 t73 t88 t55 t42 t31 t53 t34 t32 t38 t43 t51 t54 t70 t39 t35 t91 t75 t89 t87 t78 t66 t36 t9 t80 t94 t84 t50 t20 t24 t49 - trace_state
  ...
  (:init
    ...
    (= (trace_parameter a1 integer t5 t6) 80)
    ...
    (= (trace_parameter a2 integer t7 t8) 9)
    ...
    (= (trace_parameter a4 integer t17 t18) 5)

    (trace t18 a10 t19)
    (has_parameter a10 integer t18 t19)
    (= (trace_parameter a10 integer t18 t19) 9)
    ...
    (= (trace_parameter a2 integer t23 t24) 5)

    (trace t24 a9 t25)
    (has_parameter a9 categorical t24 t25)
    (= (trace_parameter a9 categorical t24 t25) 3)
    (has_parameter a9 integer t24 t25)
    (= (trace_parameter a9 integer t24 t25) 95)

    (trace t25 a3 t26)
    (has_parameter a3 integer t25 t26)
    (= (trace_parameter a3 integer t25 t26) 16)
    ...
    (= (trace_parameter a8 categorical t36 t37) 3)
    (has_parameter a8 integer t36 t37)
    (= (trace_parameter a8 integer t36 t37) 10)

    (trace t37 a8 t38)
    (has_parameter a8 integer t37 t38)
    (= (trace_parameter a8 integer t37 t38) 67)
    (has_parameter a8 categorical t37 t38)
    (= (trace_parameter a8 categorical t37 t38) 2)

    (trace t38 a10 t39)
    (has_parameter a10 integer t38 t39)
    (= (trace_parameter a10 integer t38 t39) 42)
    (has_parameter a10 categorical t38 t39)
    (= (trace_parameter a10 categorical t38 t39) 2)

    (trace t39 a1 t40)
    (has_parameter a1 integer t39 t40)
    (= (trace_parameter a1 integer t39 t40) 76)
    ...
    (= (trace_parameter a5 categorical t42 t43) 3)
    ...
    (= (trace_parameter a2 integer t43 t44) 25)

    (trace t44 a2 t45)
    (has_parameter a2 integer t44 t45)
    (= (trace_parameter a2 integer t44 t45) 40)
    (has_parameter a2 categorical t44 t45)
    (= (trace_parameter a2 categorical t44 t45) 3)

    (trace t45 a2 t46)
    (has_parameter a2 integer t45 t46)
    (= (trace_parameter a2 integer t45 t46) 0)
    ...
    (= (trace_parameter a2 categorical t54 t55) 3)
    (has_parameter a2 integer t54 t55)
    (= (trace_parameter a2 integer t54 t55) 10)

    (trace t55 a8 t56)
    (has_parameter a8 categorical t55 t56)
    (= (trace_parameter a8 categorical t55 t56) 2)
    (has_parameter a8 integer t55 t56)
    (= (trace_parameter a8 integer t55 t56) 85)

    (trace t56 a1 t57)
    (has_parameter a1 categorical t56 t57)
    (= (trace_parameter a1 categorical t56 t57) 2)
    (has_parameter a1 integer t56 t57)
    (= (trace_parameter a1 integer t56 t57) 3)

    (trace t57 a2 t58)
    (has_parameter a2 integer t57 t58)
    (= (trace_parameter a2 integer t57 t58) 1)
    (has_parameter a2 categorical t57 t58)
    (= (trace_parameter a2 categorical t57 t58) 3)

    (trace t58 a2 t59)
    (has_parameter a2 categorical t58 t59)
    (= (trace_parameter a2 categorical t58 t59) 3)
    (has_parameter a2 integer t58 t59)
    (= (trace_parameter a2 integer t58 t59) 46)
    ...
    (= (trace_parameter a7 integer t61 t62) 48)

    (trace t62 a4 t63)
    (has_parameter a4 categorical t62 t63)
    (= (trace_parameter a4 categorical t62 t63) 2)
    (has_parameter a4 integer t62 t63)
    (= (trace_parameter a4 integer t62 t63) 10)

    (trace t63 a8 t64)
    (has_parameter a8 integer t63 t64)
    (= (trace_parameter a8 integer t63 t64) 3)
    (has_parameter a8 categorical t63 t64)
    (= (trace_parameter a8 categorical t63 t64) 2)

    (trace t64 a3 t65)
    (has_parameter a3 integer t64 t65)
    (= (trace_parameter a3 integer t64 t65) 27)
    (has_parameter a3 categorical t64 t65)
    (= (trace_parameter a3 categorical t64 t65) 3)
    ...
    (= (trace_parameter a1 integer t66 t67) 10)
    ...
    (= (trace_parameter a2 categorical t67 t68) 1)

    (trace t68 a1 t69)
    (has_parameter a1 categorical t68 t69)
    (= (trace_parameter a1 categorical t68 t69) 2)
    (has_parameter a1 integer t68 t69)
    (= (trace_parameter a1 integer t68 t69) 14)

    (trace t69 a10 t70)
    (has_parameter a10 categorical t69 t70)
    (= (trace_parameter a10 categorical t69 t70) 1)
    (has_parameter a10 integer t69 t70)
    (= (trace_parameter a10 integer t69 t70) 93)

    (trace t70 a2 t71)
    (has_parameter a2 categorical t70 t71)
    (= (trace_parameter a2 categorical t70 t71) 2)
    (has_parameter a2 integer t70 t71)
    (= (trace_parameter a2 integer t70 t71) 0)

    (trace t71 a5 t72)
    (has_parameter a5 categorical t71 t72)
    (= (trace_parameter a5 categorical t71 t72) 3)
    (has_parameter a5 integer t71 t72)
    (= (trace_parameter a5 integer t71 t72) 98)

    (trace t72 a4 t73)
    (has_parameter a4 integer t72 t73)
    (= (trace_parameter a4 integer t72 t73) 0)
    (has_parameter a4 categorical t72 t73)
    (= (trace_parameter a4 categorical t72 t73) 3)

    (trace t73 a3 t74)
    (has_parameter a3 categorical t73 t74)
    (= (trace_parameter a3 categorical t73 t74) 3)
    (has_parameter a3 integer t73 t74)
    (= (trace_parameter a3 integer t73 t74) 9)
    ...
    (= (trace_parameter a7 integer t80 t81) 65)

    (trace t81 a5 t82)
    (has_parameter a5 integer t81 t82)
    (= (trace_parameter a5 integer t81 t82) 4)
    (has_parameter a5 categorical t81 t82)
    (= (trace_parameter a5 categorical t81 t82) 3)

    (trace t82 a5 t83)
    (has_parameter a5 categorical t82 t83)
    (= (trace_parameter a5 categorical t82 t83) 2)
    (has_parameter a5 integer t82 t83)
    (= (trace_parameter a5 integer t82 t83) 67)

    (trace t83 a2 t84)
    (has_parameter a2 integer t83 t84)
    (= (trace_parameter a2 integer t83 t84) 10)
    (has_parameter a2 categorical t83 t84)
    (= (trace_parameter a2 categorical t83 t84) 2)

    (trace t84 a1 t85)
    (has_parameter a1 integer t84 t85)
    (= (trace_parameter a1 integer t84 t85) 31)
    (has_parameter a1 categorical t84 t85)
    (= (trace_parameter a1 categorical t84 t85) 3)
    ...
    (trace t86 a9 t87)
    (has_parameter a9 categorical t86 t87)
    (= (trace_parameter a9 categorical t86 t87) 1)
    (has_parameter a9 integer t86 t87)
    (= (trace_parameter a9 integer t86 t87) 37)

    (trace t87 a3 t88)
    (has_parameter a3 integer t87 t88)
    (= (trace_parameter a3 integer t87 t88) 10)
    (has_parameter a3 categorical t87 t88)
    (= (trace_parameter a3 categorical t87 t88) 1)

    (trace t88 a7 t89)
    (has_parameter a7 integer t88 t89)
    (= (trace_parameter a7 integer t88 t89) 50)
    (has_parameter a7 categorical t88 t89)
    (= (trace_parameter a7 categorical t88 t89) 1)
    ...
    (= (trace_parameter a4 categorical t94 t95) 1)
    (has_parameter a4 integer t94 t95)
    (= (trace_parameter a4 integer t94 t95) 0)
