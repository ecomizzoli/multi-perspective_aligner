(define (problem prob-trace)
  ...
  (:objects
    t62 t49 t6 t77 t58 t96 t72 t52 t63 t79 t65 t32 t48 t27 t36 t57 t94 t50 t24 t53 t30 t84 t19 t87 t10 t11 t99 t7 t64 t66 t46 t75 t56 t23 t42 t45 t0 t43 t98 t35 t70 t16 t68 t61 t22 t3 t90 t92 t33 t15 t25 t31 t47 t13 t44 t89 t28 t93 t2 t51 t40 t38 t9 t85 t86 t95 t80 t39 t59 t1 t74 t82 t34 t88 t78 t54 t20 t4 t55 t26 t5 t97 t37 t60 t21 t83 t81 t12 t14 t73 t41 t18 t91 t67 t8 t76 t17 t69 t29 t71 - trace_state
  ...
  (:init
    ...
    (= (trace_parameter a1 integer t0 t1) 11)
    ...
    (= (trace_parameter a7 categorical t5 t6) 3)
    (has_parameter a7 integer t5 t6)
    (= (trace_parameter a7 integer t5 t6) 52)

    (trace t6 a9 t7)
    (has_parameter a9 integer t6 t7)
    (= (trace_parameter a9 integer t6 t7) 8)
    ...
    (= (trace_parameter a2 integer t10 t11) 10)
    ...
    (= (trace_parameter a3 integer t11 t12) 49)

    (trace t12 a9 t13)
    (has_parameter a9 integer t12 t13)
    (= (trace_parameter a9 integer t12 t13) 19)
    ...
    (= (trace_parameter a2 integer t16 t17) 9)

    (trace t17 a9 t18)
    (has_parameter a9 integer t17 t18)
    (= (trace_parameter a9 integer t17 t18) 9)
    ...
    (trace t19 a6 t20)
    (has_parameter a6 integer t19 t20)
    (= (trace_parameter a6 integer t19 t20) 10)
    (has_parameter a6 categorical t19 t20)
    (= (trace_parameter a6 categorical t19 t20) 3)

    (trace t20 a7 t21)
    (has_parameter a7 categorical t20 t21)
    (= (trace_parameter a7 categorical t20 t21) 2)
    (has_parameter a7 integer t20 t21)
    (= (trace_parameter a7 integer t20 t21) 76)
    ...
    (= (trace_parameter a7 categorical t22 t23) 1)
    (has_parameter a7 integer t22 t23)
    (= (trace_parameter a7 integer t22 t23) 62)
    ...
    (= (trace_parameter a10 integer t35 t36) 92)
    ...
    (= (trace_parameter a10 integer t36 t37) 9)
    ...
    (= (trace_parameter a10 integer t39 t40) 0)

    (trace t40 a7 t41)
    (has_parameter a7 integer t40 t41)
    (= (trace_parameter a7 integer t40 t41) 94)
    ...
    (= (trace_parameter a1 integer t44 t45) 10)
    ...
    (= (trace_parameter a2 integer t46 t47) 1)
    ...
    (= (trace_parameter a2 integer t52 t53) 75)
    ...
    (= (trace_parameter a9 integer t53 t54) 2)

    (trace t54 a7 t55)
    (has_parameter a7 integer t54 t55)
    (= (trace_parameter a7 integer t54 t55) 27)
    (has_parameter a7 categorical t54 t55)
    (= (trace_parameter a7 categorical t54 t55) 2)

    (trace t55 a9 t56)
    (has_parameter a9 categorical t55 t56)
    (= (trace_parameter a9 categorical t55 t56) 2)
    (has_parameter a9 integer t55 t56)
    (= (trace_parameter a9 integer t55 t56) 10)
    ...
    (= (trace_parameter a3 categorical t57 t58) 2)
    (has_parameter a3 integer t57 t58)
    (= (trace_parameter a3 integer t57 t58) 4)
    ...
    (= (trace_parameter a10 integer t59 t60) 10)

    (trace t60 a8 t61)
    (has_parameter a8 categorical t60 t61)
    (= (trace_parameter a8 categorical t60 t61) 2)
    (has_parameter a8 integer t60 t61)
    (= (trace_parameter a8 integer t60 t61) 10)
    ...
    (= (trace_parameter a4 categorical t62 t63) 3)
    ...
    (trace t64 a8 t65)
    (has_parameter a8 categorical t64 t65)
    (= (trace_parameter a8 categorical t64 t65) 2)
    (has_parameter a8 integer t64 t65)
    (= (trace_parameter a8 integer t64 t65) 10)
    ...
    (= (trace_parameter a1 integer t66 t67) 17)
    ...
    (= (trace_parameter a1 integer t69 t70) 20)
    ...
    (= (trace_parameter a5 categorical t71 t72) 2)
    (has_parameter a5 integer t71 t72)
    (= (trace_parameter a5 integer t71 t72) 88)

    (trace t72 a2 t73)
    (has_parameter a2 integer t72 t73)
    (= (trace_parameter a2 integer t72 t73) 2)
    (has_parameter a2 categorical t72 t73)
    (= (trace_parameter a2 categorical t72 t73) 1)
    ...
    (= (trace_parameter a9 integer t74 t75) 94)
    ...
    (= (trace_parameter a2 integer t76 t77) 64)
    ...
    (= (trace_parameter a5 integer t85 t86) 0)

    (trace t86 a9 t87)
    (has_parameter a9 integer t86 t87)
    (= (trace_parameter a9 integer t86 t87) 9)
    ...
    (= (trace_parameter a7 integer t92 t93) 62)

    (trace t93 a2 t94)
    (has_parameter a2 integer t93 t94)
    (= (trace_parameter a2 integer t93 t94) 9)
    (has_parameter a2 categorical t93 t94)
    (= (trace_parameter a2 categorical t93 t94) 1)

    (trace t94 a1 t95)
    (has_parameter a1 categorical t94 t95)
    (= (trace_parameter a1 categorical t94 t95) 3)
    (has_parameter a1 integer t94 t95)
    (= (trace_parameter a1 integer t94 t95) 1)

    (trace t95 a4 t96)
    (has_parameter a4 integer t95 t96)
    (= (trace_parameter a4 integer t95 t96) 6)
    (has_parameter a4 categorical t95 t96)
    (= (trace_parameter a4 categorical t95 t96) 1)

    (trace t96 a4 t97)
    (has_parameter a4 integer t96 t97)
    (= (trace_parameter a4 integer t96 t97) 37)
    ...
    (= (trace_parameter a3 integer t98 t99) 91)
