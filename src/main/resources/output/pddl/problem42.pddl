(define (problem prob-trace)
  ...
  (:objects
    t73 t69 t60 t86 t78 t82 t41 t79 t19 t47 t98 t28 t87 t13 t51 t83 t30 t70 t91 t17 t36 t33 t20 t61 t5 t93 t50 t97 t48 t15 t62 t39 t58 t53 t26 t74 t59 t4 t89 t37 t44 t54 t10 t94 t40 t56 t55 t12 t90 t77 t34 t23 t3 t67 t64 t22 t38 t99 t2 t75 t66 t43 t81 t52 t14 t27 t68 t25 t31 t35 t16 t45 t88 t96 t49 t57 t11 t1 t42 t8 t80 t29 t72 t85 t18 t71 t92 t6 t65 t46 t84 t0 t76 t32 t24 t63 t21 t7 t9 t95 - trace_state
  ...
  (:init
    ...
    (= (trace_parameter a4 integer t8 t9) 10)

    (trace t9 a1 t10)
    (has_parameter a1 categorical t9 t10)
    (= (trace_parameter a1 categorical t9 t10) 3)
    (has_parameter a1 integer t9 t10)
    (= (trace_parameter a1 integer t9 t10) 51)
    ...
    (= (trace_parameter a2 integer t12 t13) 10)
    (has_parameter a2 categorical t12 t13)
    (= (trace_parameter a2 categorical t12 t13) 3)

    (trace t13 a7 t14)
    (has_parameter a7 integer t13 t14)
    (= (trace_parameter a7 integer t13 t14) 20)
    (has_parameter a7 categorical t13 t14)
    (= (trace_parameter a7 categorical t13 t14) 2)

    (trace t14 a9 t15)
    (has_parameter a9 categorical t14 t15)
    (= (trace_parameter a9 categorical t14 t15) 2)
    (has_parameter a9 integer t14 t15)
    (= (trace_parameter a9 integer t14 t15) 65)

    (trace t15 a8 t16)
    (has_parameter a8 integer t15 t16)
    (= (trace_parameter a8 integer t15 t16) 8)
    (has_parameter a8 categorical t15 t16)
    (= (trace_parameter a8 categorical t15 t16) 2)

    (trace t16 a5 t17)
    (has_parameter a5 integer t16 t17)
    (= (trace_parameter a5 integer t16 t17) 10)
    (has_parameter a5 categorical t16 t17)
    (= (trace_parameter a5 categorical t16 t17) 1)

    (trace t17 a8 t18)
    (has_parameter a8 integer t17 t18)
    (= (trace_parameter a8 integer t17 t18) 10)
    ...
    (= (trace_parameter a3 categorical t18 t19) 2)

    (trace t19 a7 t20)
    (has_parameter a7 integer t19 t20)
    (= (trace_parameter a7 integer t19 t20) 10)
    (has_parameter a7 categorical t19 t20)
    (= (trace_parameter a7 categorical t19 t20) 1)

    (trace t20 a6 t21)
    (has_parameter a6 categorical t20 t21)
    (= (trace_parameter a6 categorical t20 t21) 1)
    ...
    (= (trace_parameter a2 integer t21 t22) 1)
    ...
    (= (trace_parameter a10 integer t23 t24) 100)

    (trace t24 a1 t25)
    (has_parameter a1 integer t24 t25)
    (= (trace_parameter a1 integer t24 t25) 40)
    ...
    (= (trace_parameter a2 categorical t26 t27) 1)
    ...
    (= (trace_parameter a9 integer t27 t28) 47)
    ...
    (= (trace_parameter a10 integer t32 t33) 89)
    (has_parameter a10 categorical t32 t33)
    (= (trace_parameter a10 categorical t32 t33) 2)

    (trace t33 a5 t34)
    (has_parameter a5 categorical t33 t34)
    (= (trace_parameter a5 categorical t33 t34) 1)
    (has_parameter a5 integer t33 t34)
    (= (trace_parameter a5 integer t33 t34) 10)
    ...
    (= (trace_parameter a2 categorical t35 t36) 3)
    (has_parameter a2 integer t35 t36)
    (= (trace_parameter a2 integer t35 t36) 10)

    (trace t36 a10 t37)
    (has_parameter a10 categorical t36 t37)
    (= (trace_parameter a10 categorical t36 t37) 1)
    (has_parameter a10 integer t36 t37)
    (= (trace_parameter a10 integer t36 t37) 10)
    ...
    (= (trace_parameter a6 integer t38 t39) 0)
    (has_parameter a6 categorical t38 t39)
    (= (trace_parameter a6 categorical t38 t39) 2)

    (trace t39 a5 t40)
    (has_parameter a5 categorical t39 t40)
    (= (trace_parameter a5 categorical t39 t40) 1)
    ...
    (= (trace_parameter a2 integer t48 t49) 10)
    (has_parameter a2 categorical t48 t49)
    (= (trace_parameter a2 categorical t48 t49) 2)

    (trace t49 a3 t50)
    (has_parameter a3 categorical t49 t50)
    (= (trace_parameter a3 categorical t49 t50) 3)
    (has_parameter a3 integer t49 t50)
    (= (trace_parameter a3 integer t49 t50) 7)

    (trace t50 a7 t51)
    (has_parameter a7 categorical t50 t51)
    (= (trace_parameter a7 categorical t50 t51) 2)
    (has_parameter a7 integer t50 t51)
    (= (trace_parameter a7 integer t50 t51) 10)

    (trace t51 a9 t52)
    (has_parameter a9 integer t51 t52)
    (= (trace_parameter a9 integer t51 t52) 10)
    (has_parameter a9 categorical t51 t52)
    (= (trace_parameter a9 categorical t51 t52) 3)

    (trace t52 a1 t53)
    (has_parameter a1 integer t52 t53)
    (= (trace_parameter a1 integer t52 t53) 10)
    (has_parameter a1 categorical t52 t53)
    (= (trace_parameter a1 categorical t52 t53) 2)

    (trace t53 a3 t54)
    (has_parameter a3 integer t53 t54)
    (= (trace_parameter a3 integer t53 t54) 10)
    ...
    (= (trace_parameter a7 integer t82 t83) 10)

    (trace t83 a7 t84)
    (has_parameter a7 categorical t83 t84)
    (= (trace_parameter a7 categorical t83 t84) 2)
    (has_parameter a7 integer t83 t84)
    (= (trace_parameter a7 integer t83 t84) 46)

    (trace t84 a3 t85)
    (has_parameter a3 integer t84 t85)
    (= (trace_parameter a3 integer t84 t85) 90)
    (has_parameter a3 categorical t84 t85)
    (= (trace_parameter a3 categorical t84 t85) 2)

    (trace t85 a10 t86)
    (has_parameter a10 integer t85 t86)
    (= (trace_parameter a10 integer t85 t86) 19)
    (has_parameter a10 categorical t85 t86)
    (= (trace_parameter a10 categorical t85 t86) 2)

    (trace t86 a5 t87)
    (has_parameter a5 categorical t86 t87)
    (= (trace_parameter a5 categorical t86 t87) 2)
    (has_parameter a5 integer t86 t87)
    (= (trace_parameter a5 integer t86 t87) 11)

    (trace t87 a9 t88)
    (has_parameter a9 categorical t87 t88)
    (= (trace_parameter a9 categorical t87 t88) 1)
    (has_parameter a9 integer t87 t88)
    (= (trace_parameter a9 integer t87 t88) 9)

    (trace t88 a5 t89)
    (has_parameter a5 categorical t88 t89)
    (= (trace_parameter a5 categorical t88 t89) 2)
    (has_parameter a5 integer t88 t89)
    (= (trace_parameter a5 integer t88 t89) 0)

    (trace t89 a7 t90)
    (has_parameter a7 integer t89 t90)
    (= (trace_parameter a7 integer t89 t90) 35)
    (has_parameter a7 categorical t89 t90)
    (= (trace_parameter a7 categorical t89 t90) 1)
    ...
    (= (trace_parameter a7 integer t91 t92) 41)
    (has_parameter a7 categorical t91 t92)
    (= (trace_parameter a7 categorical t91 t92) 2)

    (trace t92 a8 t93)
    (has_parameter a8 categorical t92 t93)
    (= (trace_parameter a8 categorical t92 t93) 2)
    (has_parameter a8 integer t92 t93)
    (= (trace_parameter a8 integer t92 t93) 10)

    (trace t93 a9 t94)
    (has_parameter a9 categorical t93 t94)
    (= (trace_parameter a9 categorical t93 t94) 1)
    (has_parameter a9 integer t93 t94)
    (= (trace_parameter a9 integer t93 t94) 10)

    (trace t94 a4 t95)
    (has_parameter a4 categorical t94 t95)
    (= (trace_parameter a4 categorical t94 t95) 3)
    (has_parameter a4 integer t94 t95)
    (= (trace_parameter a4 integer t94 t95) 59)

    (trace t95 a3 t96)
    (has_parameter a3 integer t95 t96)
    (= (trace_parameter a3 integer t95 t96) 10)
    (has_parameter a3 categorical t95 t96)
    (= (trace_parameter a3 categorical t95 t96) 3)

    (trace t96 a4 t97)
    (has_parameter a4 categorical t96 t97)
    (= (trace_parameter a4 categorical t96 t97) 2)
    (has_parameter a4 integer t96 t97)
    (= (trace_parameter a4 integer t96 t97) 39)

    (trace t97 a10 t98)
    (has_parameter a10 categorical t97 t98)
    (= (trace_parameter a10 categorical t97 t98) 1)
    (has_parameter a10 integer t97 t98)
    (= (trace_parameter a10 integer t97 t98) 10)

    (trace t98 a6 t99)
    (has_parameter a6 categorical t98 t99)
    (= (trace_parameter a6 categorical t98 t99) 2)
