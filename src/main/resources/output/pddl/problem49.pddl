(define (problem prob-trace)
  ...
  (:objects
    t68 t38 t6 t55 t50 t44 t60 t81 t17 t86 t54 t20 t12 t36 t90 t76 t84 t25 t67 t83 t61 t64 t11 t65 t27 t3 t93 t48 t42 t92 t51 t57 t32 t9 t63 t10 t96 t13 t24 t35 t46 t34 t39 t73 t4 t49 t16 t19 t62 t18 t56 t72 t2 t71 t8 t80 t33 t70 t41 t78 t59 t79 t0 t98 t89 t94 t52 t95 t23 t88 t29 t45 t5 t87 t82 t43 t26 t74 t28 t31 t69 t21 t85 t7 t53 t58 t22 t15 t37 t30 t77 t1 t14 t97 t47 t66 t40 t91 t75 t99 - trace_state
  ...
  (:init
    ...
    (= (trace_parameter a7 integer t10 t11) 3)
    (has_parameter a7 categorical t10 t11)
    (= (trace_parameter a7 categorical t10 t11) 2)

    (trace t11 a10 t12)
    (has_parameter a10 categorical t11 t12)
    (= (trace_parameter a10 categorical t11 t12) 2)
    (has_parameter a10 integer t11 t12)
    (= (trace_parameter a10 integer t11 t12) 62)

    (trace t12 a7 t13)
    (has_parameter a7 integer t12 t13)
    (= (trace_parameter a7 integer t12 t13) 91)
    (has_parameter a7 categorical t12 t13)
    (= (trace_parameter a7 categorical t12 t13) 1)
    ...
    (= (trace_parameter a6 integer t14 t15) 7)
    ...
    (= (trace_parameter a8 integer t15 t16) 89)

    (trace t16 a9 t17)
    (has_parameter a9 integer t16 t17)
    (= (trace_parameter a9 integer t16 t17) 100)
    ...
    (= (trace_parameter a4 integer t22 t23) 0)
    ...
    (= (trace_parameter a2 integer t24 t25) 9)
    ...
    (= (trace_parameter a9 categorical t25 t26) 1)

    (trace t26 a1 t27)
    (has_parameter a1 integer t26 t27)
    (= (trace_parameter a1 integer t26 t27) 70)
    (has_parameter a1 categorical t26 t27)
    (= (trace_parameter a1 categorical t26 t27) 3)
    ...
    (= (trace_parameter a10 integer t33 t34) 0)
    ...
    (= (trace_parameter a10 categorical t35 t36) 1)
    ...
    (= (trace_parameter a2 integer t40 t41) 9)
    ...
    (= (trace_parameter a9 categorical t43 t44) 3)
    ...
    (= (trace_parameter a5 integer t45 t46) 10)
    (has_parameter a5 categorical t45 t46)
    (= (trace_parameter a5 categorical t45 t46) 1)

    (trace t46 a5 t47)
    (has_parameter a5 categorical t46 t47)
    (= (trace_parameter a5 categorical t46 t47) 2)
    ...
    (= (trace_parameter a7 integer t50 t51) 0)

    (trace t51 a9 t52)
    (has_parameter a9 integer t51 t52)
    (= (trace_parameter a9 integer t51 t52) 9)
    ...
    (= (trace_parameter a10 integer t56 t57) 9)
    (has_parameter a10 categorical t56 t57)
    (= (trace_parameter a10 categorical t56 t57) 2)

    (trace t57 a10 t58)
    (has_parameter a10 integer t57 t58)
    (= (trace_parameter a10 integer t57 t58) 14)
    (has_parameter a10 categorical t57 t58)
    (= (trace_parameter a10 categorical t57 t58) 2)

    (trace t58 a6 t59)
    (has_parameter a6 categorical t58 t59)
    (= (trace_parameter a6 categorical t58 t59) 1)
    (has_parameter a6 integer t58 t59)
    (= (trace_parameter a6 integer t58 t59) 10)

    (trace t59 a3 t60)
    (has_parameter a3 integer t59 t60)
    (= (trace_parameter a3 integer t59 t60) 84)
    ...
    (= (trace_parameter a1 integer t60 t61) 93)
    ...
    (= (trace_parameter a4 integer t62 t63) 16)
    (has_parameter a4 categorical t62 t63)
    (= (trace_parameter a4 categorical t62 t63) 2)

    (trace t63 a7 t64)
    (has_parameter a7 integer t63 t64)
    (= (trace_parameter a7 integer t63 t64) 10)
    (has_parameter a7 categorical t63 t64)
    (= (trace_parameter a7 categorical t63 t64) 3)

    (trace t64 a2 t65)
    (has_parameter a2 integer t64 t65)
    (= (trace_parameter a2 integer t64 t65) 9)
    (has_parameter a2 categorical t64 t65)
    (= (trace_parameter a2 categorical t64 t65) 2)
    ...
    (trace t73 a6 t74)
    (has_parameter a6 integer t73 t74)
    (= (trace_parameter a6 integer t73 t74) 10)
    (has_parameter a6 categorical t73 t74)
    (= (trace_parameter a6 categorical t73 t74) 1)

    (trace t74 a1 t75)
    (has_parameter a1 integer t74 t75)
    (= (trace_parameter a1 integer t74 t75) 100)
    (has_parameter a1 categorical t74 t75)
    (= (trace_parameter a1 categorical t74 t75) 2)

    (trace t75 a5 t76)
    (has_parameter a5 integer t75 t76)
    (= (trace_parameter a5 integer t75 t76) 100)
    ...
    (= (trace_parameter a2 integer t80 t81) 8)
    (has_parameter a2 categorical t80 t81)
    (= (trace_parameter a2 categorical t80 t81) 1)

    (trace t81 a2 t82)
    (has_parameter a2 categorical t81 t82)
    (= (trace_parameter a2 categorical t81 t82) 2)
    (has_parameter a2 integer t81 t82)
    (= (trace_parameter a2 integer t81 t82) 10)

    (trace t82 a4 t83)
    (has_parameter a4 integer t82 t83)
    (= (trace_parameter a4 integer t82 t83) 59)
    ...
    (= (trace_parameter a9 categorical t85 t86) 1)
    (has_parameter a9 integer t85 t86)
    (= (trace_parameter a9 integer t85 t86) 72)

    (trace t86 a9 t87)
    (has_parameter a9 categorical t86 t87)
    (= (trace_parameter a9 categorical t86 t87) 2)
    (has_parameter a9 integer t86 t87)
    (= (trace_parameter a9 integer t86 t87) 0)
